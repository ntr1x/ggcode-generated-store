...
const label = computed(() => {
  switch (true) {
    ...
    case props.value != undefined: return props.value == null ? null : [props.value.name, props.value.patronymic, props.value.surname].filter(item => item != null).join(" ")
    default: return null
  }
})
...
const route = computed(() => {
  switch (true) {
    ...
    case props.value != undefined: return props.value == null ? null : `/admin/customers/${props.value.id}`
    default: return null
  }
})
