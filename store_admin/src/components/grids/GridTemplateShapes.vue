...
export type GridTemplateShapesRecord = Record<string, any>

export type GridTemplateShapesPage = {
  content: GridTemplateShapesRecord[]
}

export type GridTemplateShapesProps = {
  state: State<GridTemplateShapesPage>,
  scrollable?: boolean,
  scrollHeight?: string,
  hideId?: boolean,
  hideName?: boolean,
...
const selection = defineModel<GridTemplateShapesRecord[]>('selection')

withDefaults(defineProps<GridTemplateShapesProps>(), {
  scrollable: true,
  scrollHeight: 'flex',
})
