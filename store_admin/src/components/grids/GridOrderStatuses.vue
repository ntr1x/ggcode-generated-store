...
export type GridOrderStatusesRecord = Record<string, any>

export type GridOrderStatusesPage = {
  content: GridOrderStatusesRecord[]
}

export type GridOrderStatusesProps = {
  state: State<GridOrderStatusesPage>,
  scrollable?: boolean,
  scrollHeight?: string,
  hideId?: boolean,
  hideName?: boolean,
...
const selection = defineModel<GridOrderStatusesRecord[]>('selection')
