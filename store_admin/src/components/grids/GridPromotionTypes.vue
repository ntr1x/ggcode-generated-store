...
export type GridPromotionTypesRecord = Record<string, any>

export type GridPromotionTypesPage = {
  content: GridPromotionTypesRecord[]
}

export type GridPromotionTypesProps = {
  state: State<GridPromotionTypesPage>,
  scrollable?: boolean,
  scrollHeight?: string,
  hideId?: boolean,
  hideName?: boolean,
...
const selection = defineModel<GridPromotionTypesRecord[]>('selection')

withDefaults(defineProps<GridPromotionTypesProps>(), {
  scrollable: true,
  scrollHeight: 'flex',
})
