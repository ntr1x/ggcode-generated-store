...
[[ -z "$MYSQL_HOSTNAME" ]] && fail "[ERROR] MYSQL_HOSTNAME environment variable should be set"
[[ -z "$MYSQL_PORT" ]] && fail "[ERROR] MYSQL_PORT environment variable should be set"
[[ -z "$MYSQL_DATABASE" ]] && fail "[ERROR] MYSQL_DATABASE environment variable should be set"
[[ -z "$MYSQL_USERNAME" ]] && fail "[ERROR] MYSQL_USERNAME environment variable should be set"
[[ -z "$MYSQL_PASSWORD" ]] && fail "[ERROR] MYSQL_PASSWORD environment variable should be set"
