...
public interface SystemPublicEventTopicInfoResponse {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(name = "SystemPublicEventTopicInfoResponseRemove")
    class Remove {
        @JsonView(Views.Default.class)
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(name = "SystemPublicEventTopicInfoResponseRemoveAll")
    class RemoveAll {
        @JsonView(Views.Default.class)
        private Collection<SystemPublicEventTopicInfoModel> removed;
    }
