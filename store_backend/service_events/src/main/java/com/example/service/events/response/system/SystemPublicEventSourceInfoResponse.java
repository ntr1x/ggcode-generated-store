...
public interface SystemPublicEventSourceInfoResponse {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(name = "SystemPublicEventSourceInfoResponseRemove")
    class Remove {
        @JsonView(Views.Default.class)
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(name = "SystemPublicEventSourceInfoResponseRemoveAll")
    class RemoveAll {
        @JsonView(Views.Default.class)
        private Collection<SystemPublicEventSourceInfoModel> removed;
    }
