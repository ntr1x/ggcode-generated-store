...
public interface SystemPublicSubscriptionTypeResponse {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(name = "SystemPublicSubscriptionTypeResponseRemove")
    class Remove {
        @JsonView(Views.Default.class)
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(name = "SystemPublicSubscriptionTypeResponseRemoveAll")
    class RemoveAll {
        @JsonView(Views.Default.class)
        private Collection<SystemPublicSubscriptionTypeModel> removed;
    }
