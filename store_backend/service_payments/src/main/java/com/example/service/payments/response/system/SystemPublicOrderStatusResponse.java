...
public interface SystemPublicOrderStatusResponse {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(name = "SystemPublicOrderStatusResponseRemove")
    class Remove {
        @JsonView(Views.Default.class)
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    @Schema(name = "SystemPublicOrderStatusResponseRemoveAll")
    class RemoveAll {
        @JsonView(Views.Default.class)
        private Collection<SystemPublicOrderStatusModel> removed;
    }
